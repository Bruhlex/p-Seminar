...
function loadContent(type) {
    ...
    switch(type) {
        ...
        case "start_b":
            tip_type = "1"
            string = `Auch dieser Wert befindet sich nicht hier.  <br> Jedoch hat die Variable etwas mit den momentan infizierten PC's zu tun. <br> Suche nach dieser Zahl und <br> nimm die Quersumme der gerundeten ganzen Zahl für "b"`
            break
        default:
    }
